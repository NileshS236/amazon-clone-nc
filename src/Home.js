    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            id="49538094"
            title="Hafele Glamline Series - Multifunctional Power Mixer with 3 Mixing Attachments, 4 Litre Mixer"
            price={17600.56}
            rating={Math.floor(3)}
            image="https://m.media-amazon.com/images/I/41eqQ05eN5L._AC_UL480_FMwebp_QL65_.jpg"
          />
        </div>
        <div className="home__row">
          <Product
